...
class Monitor(Estudante,Funcionario):
    ...
    def set_carga(self,carga_horaria):
        self.__carga_horaria=carga_horaria
...
print("Carga Horaria:", monitor.get_carga_horaria()) 
print('-'*30)#print varias coisas
monitor.set_disciplina('BD')         # POO
monitor.set_carga(30)
print("Disciplina:", monitor.get_disciplina())          # POO
print("Carga Horaria:", monitor.get_carga_horaria()) 